...
final class Version20241016073850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuario_curso (usuario_id INT NOT NULL, curso_id INT NOT NULL, INDEX IDX_D7E52AF2DB38439E (usuario_id), INDEX IDX_D7E52AF287CB4A1F (curso_id), PRIMARY KEY(usuario_id, curso_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
